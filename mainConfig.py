...
configuration_parameters = {
    ...
    'addr': ['Address', str, '127.0.0.1', 'a', 'Address for the UDP socket', lambda a: parameterChecks.check_address(a), False],
    'port': ['Port', int, 18001, 'p', 'Port for the UDP socket', lambda a: str(a).isdigit() and 1024 <= int(a) <= 65353, False],
