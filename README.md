...
-|-|-|-
-i|Logging level for the printed log messages<br />Level 1: Print errors<br />Level 2: Print warnings<br />Level 3: Print processing information<br />Level 4: Print debug messages<br />Level 5: Print detailed debug messages|3|1 - 5
