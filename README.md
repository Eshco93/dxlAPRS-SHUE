...
`-b`|List of all radiosondes enabled for upload<br />Separated by commas<br />By default upload for all radiosondes is enabled|`RS41,RS92,DFM,<br />iMET,M10,M20,MRZ,MEISEI`|-
