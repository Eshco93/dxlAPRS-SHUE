...
-l|User position for showing the station on the [SondeHub Tracker](https://sondehub.org/) Map<br />Format: [lat, lon, alt] with lat and lon in decimal degrees and alt in meters|[0.0, 0.0, 0.0]|-
-i|Test|127.0.0.1|-
-u|Test|127.0.0.1|-
-g|Test|127.0.0.1|-
-r|Test|127.0.0.1|-
